...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1f3f3f3d79ae922d4cde2b6047d5fbe7) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$lwt_server", []))];
     ...
     doc =
       [
          ("dns", OCamlbuildDocPlugin.doc_build "lib");
          ("dns_lwt", OCamlbuildDocPlugin.doc_build "lwt")
       ];
     ...
     clean_doc =
       [
          ("dns", OCamlbuildDocPlugin.doc_clean "lib");
          ("dns_lwt", OCamlbuildDocPlugin.doc_clean "lwt")
       ];
     distclean = [];
     distclean_test =
       [
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["binding_crypto.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lcrypto"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, [])];
                      bs_nativeopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules =
                        ["Dns_server"; "Dns_resolver"; "Sec"; "Dnssec_rsa"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "dns";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "lwt_server.ml"; });
               Executable
                 ({
                     cs_name = "time_server";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "time_server.ml"; });
               Executable
                 ({
                     cs_name = "mldig";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "mldig.ml"; });
               Executable
                 ({
                     cs_name = "load_key";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "load_key.ml"; });
               Executable
                 ({
                     cs_name = "test_robustness";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "test_robustness.ml"; 
                   });
               Test
                 ({
                     cs_name = "lwt_server";
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "s\168\026\000\135-\162>\145\214\167\000M=\218\218";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
